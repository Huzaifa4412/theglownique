...
// Colour data now lives in lib/neon-colors.ts (shared with the homepage
// colour studio). Re-exported so existing importers keep working.
export { NEON_COLORS };
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-1 rounded-full border text-[11px] font-medium transition-all duration-300 min-h-[32px] ${
                      isPartyMode || activeColor.id === "rgba-cycle"
                        ? "bg-pink-500/20 border-pink-500 text-pink-300 shadow-[0_0_12px_rgba(169,45,86,0.4)]"
