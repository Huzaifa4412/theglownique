...
const timelineItems = [
  {
    ...
    copy: "Send your logo, font, or rough sketch. We recommend the ideal sign type, scale, and lighting style for your space.",
    icon: "FileText",
    tone: "purple",
  },
  {
    day: "Day 2",
    title: "Free 1-on-1 Design Proof",
    copy: "Receive a scaled digital proof with exact Pantone/RGB colors and backing cutlines. Unlimited revisions included.",
    icon: "ImageSquare",
    tone: "pink",
  },
  {
    day: "Day 3–10",
    title: "Handcraft & 24hr Testing",
    copy: "Laser cutting, hand bending, soldered connections, and a rigorous 24-hour burn-in luminance inspection.",
    icon: "Cube",
    tone: "purple",
  },
  {
    day: "Day 10–15",
    title: "Crated Tracked Delivery",
    copy: "Packed in reinforced timber crates with dimmer remote, power supply, and standoff mounting hardware included.",
    icon: "Truck",
    tone: "pink",
  },
