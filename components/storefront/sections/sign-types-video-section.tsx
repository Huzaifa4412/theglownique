...
export function SignTypesVideoSection() {
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute -top-40 right-0 w-[600px] h-[600px] rounded-full bg-gradient-to-br from-[#a92d56]/15 via-[#6b4664]/10 to-transparent blur-[140px]"
        aria-hidden="true"
      />
      <div
        className="pointer-events-none absolute -bottom-40 left-0 w-[600px] h-[600px] rounded-full bg-gradient-to-tr from-[#6b4664]/15 via-[#a92d56]/10 to-transparent blur-[140px]"
        aria-hidden="true"
      />
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 rounded-2xl text-xs sm:text-sm font-semibold transition-all duration-300 min-h-[44px] ${
                  isActive
                    ? "bg-gradient-to-r from-[#a92d56] to-[#6b4664] text-white shadow-[0_0_24px_rgba(169,45,86,0.4)] scale-105"
                    ...
                    return (
                      <button
                        ...
                        className={`px-2.5 py-1.5 rounded-xl border text-left text-xs transition-all duration-300 min-h-[40px] flex flex-col justify-center ${
                          isSelected
                            ? "bg-pink-500/20 border-pink-500 text-white shadow-[0_0_12px_rgba(169,45,86,0.4)]"
              ...
              <div className="space-y-3 mb-8">
                {currentType.features.map((feat, i) => (
                  <div key={i} className="flex items-center gap-3 text-xs sm:text-sm text-gray-200">
                    <div className="w-5 h-5 rounded-full bg-gradient-to-r from-[#a92d56] to-[#6b4664] flex items-center justify-center text-white shrink-0">
