...
const STACK_CARDS: StackCardItem[] = [
  {
    ...
    subtitle: "Vector, PNG, Font or Napkin Sketch",
    description:
  ...
  },
  {
    ...
    subtitle: "Scaled Preview Before Spending a Cent",
    description:
  ...
  },
  {
    ...
    number: "03",
    badge: "You approve",
    title: "Approve Your All-In Quote",
    subtitle: "Transparent Pricing & Split Milestones",
    description:
      "Once you love the mockup, we provide a transparent, all-in quote covering your sign, mounting hardware, dimmer remote, and tracked shipping. Pay in full or choose our 50/50 milestone option (50% to start, 50% upon completion).",
    icon: FileText,
    accentHex: "#0284c7",
    accentText: "#075985",
  ...
  },
  {
    ...
    subtitle: "100% Buyer-Protected Transaction",
    description:
      "Your order is processed securely through our verified 5-star Etsy shop with full encryption and Etsy Purchase Protection. Your payment and tracking stay safe, and we only begin handcrafting once confirmed.",
    icon: ShieldCheck,
    accentHex: "#0d9488",
    accentText: "#0f766e",
    ...
    badgeBg: "#f0fdfa",
    stats: "Etsy Purchase Protection · 5-Star rated shop",
  ...
  },
  {
    ...
    number: "05",
    badge: "We craft it",
    title: "Workshop Handcraft & 24hr Testing",
    subtitle: "Precision Assembled & Quality-Checked",
    description:
      "Our artisan signmakers laser-cut the backboard, hand-shape the commercial 12V silicone or fabricate 304 stainless steel letters, and solder every connection. Then we run a continuous 24-hour burn-in luminance check.",
    icon: Wrench,
    accentHex: "#d97706",
    accentText: "#92400e",
    ...
    badgeBg: "#fffbeb",
    stats: "24-hour continuous burn-in electrical test",
  ...
  },
  {
    ...
    badgeBg: "#ecfdf5",
    stats: "Reinforced timber crate · Fully tracked to door",
