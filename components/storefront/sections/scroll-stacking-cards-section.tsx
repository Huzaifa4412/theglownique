...
const STACK_CARDS: StackCardItem[] = [
  ...
  },
  {
    ...
    subtitle: "Encrypted Etsy checkout",
    description:
      "Your order is paid through Etsy's encrypted checkout, and eligible orders are covered by Etsy Purchase Protection. We only begin handcrafting once your payment is confirmed.",
    icon: ShieldCheck,
    accentHex: "#0d9488",
    accentText: "#0f766e",
    ...
    badgeBg: "#f0fdfa",
    stats: "Etsy Purchase Protection · eligible orders",
    previewText: "Secure checkout",
  },
  {
    id: "step-5",
    number: "05",
